...
if (!target || !["demo", "ad", "tiktok", "reddit", "reddit-paid", "tiktok-pov", "quiet-ad"].includes(target)) {
  console.error("Usage: node scripts/render-remotion.mjs <demo|ad|tiktok|reddit|reddit-paid|tiktok-pov|quiet-ad>");
  process.exit(1);
}
